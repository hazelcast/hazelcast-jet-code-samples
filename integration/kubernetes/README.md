...
You can check [Hazelcast Jet Documentation](http://docs.hazelcast.org/docs/jet/0.7.1/manual) 
and [Hazelcast Jet Management Center Documentation](https://docs.hazelcast.org/docs/jet-management-center/0.7.1/manual/) for more information.
