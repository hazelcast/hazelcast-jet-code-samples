...
public class ReadWriteRemoteCache {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Vertex source = dag.newVertex("source", SourceProcessors.readCache(SOURCE_CACHE_NAME, clientConfig));
            ...
            Vertex sink = dag.newVertex("sink", SinkProcessors.writeCache(SINK_CACHE_NAME, clientConfig));
