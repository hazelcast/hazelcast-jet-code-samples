...
/**
 * Word count sample implemented without relying on out-of-the-box
 * processors. Demonstrates the lower-level convenience API to
 * implement a cooperative processor.
 */
